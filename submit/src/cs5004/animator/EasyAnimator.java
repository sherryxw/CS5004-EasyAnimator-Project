...
public final class EasyAnimator {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    //default speed is 1, default out is System.out
    //Mandatory: fileName, viewType
    String fileName = "";
    String viewType = "";
    String speed = "1";
    String out = "" ;
    ...
    //create view
    IView view = ViewFactory.makeView(model, viewType, out, model.getAnimationBoundsW(),
    ...
    if (view.getViewType().equalsIgnoreCase("animation")) {
      ...
      controller = new TextController(view);
    }
