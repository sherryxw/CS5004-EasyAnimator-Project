...
public class AnimationReader {
  ...
  /**
   * Read information for Canvas.
   * @param s the input
   * @param builder the builder
   * @param <Doc> the type that supported by animationBuilder
   */
  ...
  private static <Doc> void readShape(Scanner s, AnimationBuilder<Doc> builder) {
    ...
    builder.declareShape(name, type);  //addShape
  }

  /**
   * Read information for Motion.
   * @param s the input
   * @param builder the builder
   * @param <Doc> the type that supported by animationBuilder
   */
  ...
  /**
   * Get int from input(not quite sure what's doing here).
   * @param  s the input
   * @param label the label
   * @param fieldName the filename
   * @return the integer
   */
